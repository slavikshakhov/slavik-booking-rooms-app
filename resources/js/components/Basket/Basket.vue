    ...
    <div class="row" v-else>
      ...
      <div class="col-md-4">
        ...
        <transition-group name="fade">
          <div v-for="item in basket" :key="item.room.id">
            <div class="pt-2 pb-2 border-top d-flex justify-content-between">
              <span>
                <router-link :to="{name: 'room', params: {id: item.room.id}}">{{ item.room.title }}</router-link>
              </span>
            ...
            <div class="pt-2 pb-2 text-right">
              <button
                ...
                @click="$store.dispatch('removeFromBasket', item.room.id)"
              >
